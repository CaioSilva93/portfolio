...
const criticalErrors = [
  {
    project: "Tracker",
    projectUrl: "http://localhost:3006",
  ...
  {
    project: "Muse",
    projectUrl: "http://localhost:3002",
  ...
  {
    project: "Pulse",
    projectUrl: "http://localhost:3003",
  ...
  {
    project: "Bazaar",
    projectUrl: "http://localhost:3004",
  ...
  {
    project: "Sync",
    projectUrl: "http://localhost:3005",
