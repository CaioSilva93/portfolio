      ...
      <Card className="w-full max-w-md border-[hsl(var(--border))] bg-[hsl(var(--card))]">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-[hsl(var(--muted-foreground))]">
            Sign in to generate AI-powered content
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleLogin}>
          <CardContent className="space-y-4">
            <p className="rounded-md bg-[hsl(var(--muted))]/50 p-3 text-xs text-[hsl(var(--muted-foreground))]">
              Note: Supabase free tier allows a maximum of 3 authentication
              emails per hour. If you hit this limit during signup, please wait
              before trying again.
            </p>
            {error && (
